  ...
  return (
    <div className="min-h-[90vh] bg-mine-shaft-950 font-[poppins] overflow-hidden relative">
      ...
      >
        ...
        {/* Middle Section */}
        <div
        className={`w-1/2 h-full transition-all duration-1000 ease-in ${
        ...
        >
          <div className="flex gap-1 items-center text-bright-sun-400">
            ...
            <div className="text-6xl font-bold">Job Hook</div>
          </div>
          <div className="text-2xl font-semibold text-mine-shaft-200 p-3">
