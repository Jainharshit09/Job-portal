...
const AboutPage = () => {
    ...
    return (
        <div className="relative min-h-screen" onMouseMove={handleMouseMove}>
            ...
            {/* Main Content */}
            <div className="relative z-10 max-w-7xl mx-auto overflow-x-hidden p-6">
                {/* Hero Section */}
                <section className="bg-mine-shaft-800/80 backdrop-blur-sm rounded-xl shadow-lg p-12 mb-16 relative">
                    <motion.div
                    ...
                    />
                    <motion.h1
                        className="text-5xl font-bold text-bright-sun-400"
